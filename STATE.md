...
`CHANGELOG.md` (current to app V.10.17 / board V.9.28) and the **git log / tags**. Onboarding:
...
- **App: V.10.17** — https://app.wkndr.xyz (cache-bust `?v=V.10.17`; GH-Pages mirror at
  ...
  **Curation Board (board V.9.28, redesigned 2026-07-22→23):** https://app.wkndr.xyz/curate/ (or the
