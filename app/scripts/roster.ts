...
export const ROSTERS: Record<string, RosterSource[]> = {
  amsterdam: [
    ...
    { facet: 'the best / most-talked-about restaurants right now', name: 'The Infatuation Amsterdam', url: 'https://www.theinfatuation.com/amsterdam', type: 'llm', category: 'eat' }, // AMS's "best restaurants" editorial (Eater doesn't cover Amsterdam)
  ...
  'new-orleans': [
    ...
    { facet: 'the BEST / most acclaimed restaurants right now (Eater Essential / best-of)', name: 'Eater New Orleans', url: 'https://nola.eater.com/', type: 'llm', category: 'eat' },
