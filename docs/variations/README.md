...
Open briefs: `002-the-no-photo-face.md` · `003-the-opening-beat.md` · `004-the-two-minute-board.md`.
Graduated: `001-the-field-is-a-verb.md` (V.12, 2026-09-25 — the glass). One branch each; the file IS the first prompt.
